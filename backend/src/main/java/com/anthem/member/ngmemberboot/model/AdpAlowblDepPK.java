...
@Embeddable
public class AdpAlowblDepPK implements Serializable {
    ...
    @Column(name="ADP_EFCTV_DT")
    private final Timestamp adpEfctvDt;

    @Column(name="CMS_RLTNSP_CD")
    private final String cmsRltnspCd;
}
